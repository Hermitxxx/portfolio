    ...
    return (
        <>
            <motion.nav
                ...
                className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled || mobileMenuOpen ? 'bg-[#050505]/95 backdrop-blur-md border-b border-[#DC143C]/10 py-1.5 md:py-2' : 'bg-transparent py-2 md:py-4'
                    }`}
            >
